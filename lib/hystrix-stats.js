...
// This number is somewhat arbitrary. However, we need to allow
...
class HystrixStats {
  constructor (circuit) {
    ...
    function snapshotListener (stats) {
    ...
    circuit.status.on('snapshot', snapshotListener);
