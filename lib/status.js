...
class Status extends EventEmitter {
  constructor (options) {
    ...
    if (this.rotateBucketController) this.rotateBucketController.on('rotate', nextBucket(this[WINDOW]));
    // or rotate the buckets periodically
    else this[BUCKET_INTERVAL] = setInterval(nextBucket(this[WINDOW]), bucketInterval);
