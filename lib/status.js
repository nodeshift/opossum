...
class Status extends EventEmitter {
  constructor (options) {
    ...
    if (this.rotateBucketController) {
      ...
      this[BUCKET_INTERVAL] = setInterval(() => this.rotateBucket(this[WINDOW]), bucketInterval);
  ...
  startListeneningForRotateEvent () {
    if (this.rotateBucketController) {
      // this.rotateBucketController.on(this[ROTATE_EVENT_NAME], () => this.rotateBucket(this[WINDOW]));
